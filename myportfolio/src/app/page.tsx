        ...
        <section className="text-center mb-12">
          <section className="my-8">
            ...
            <p className="mt-4">
              ...
              answers to seemingly impossible problems that haunt their
              imagination. Imaginative and curious, Logician personalities can
              find endless fascination in the workings of their own mind. For
              Logicians, the best conversations are like brainstorming sessions,
              with plenty of room for unconventional thoughts and off-the-wall
              what-ifs.
            </p>

            <p className="mt-4">
              Logicians pride themselves on their unique perspectives and
              vigorous intellect. They can&apos;t help but puzzle over the
              mysteries of the universe – which may explain why some of the most
              influential philosophers and scientists of all time have been
              Logicians. This personality type is fairly rare, but with their
              creativity and inventiveness, Logicians aren&apos;t afraid to stand
              out from the crowd.
            </p>

            <p className="mt-4">
              Logicians often lose themselves in thought – which isn&apos;t
              necessarily a bad thing. People with this personality type hardly
              ever stop thinking. From the moment they wake up, their minds buzz
              with ideas, questions, and insights. At times, they may even find
              themselves conducting full-fledged debates in their own heads. From
              the outside, Logicians may seem to live in a never-ending daydream.
              They have a reputation for being pensive, detached, and a bit
              reserved. That is, until they try to train all of their mental
              energy on the moment or the person at hand, which can be a bit
              uncomfortable for everyone. But regardless of which mode they&apos;re
              in, Logicians are Introverts and tend to get tired out by extensive
              socializing. After a long day, they crave time alone to consult
              their own thoughts.
            </p>
            ...
            <div className="my-8">
              ...
              <p>
                Logicians are innovative inventors with an unquenchable thirst
                for knowledge.
              </p>
          ...
          <div className="space-y-8">
            {[
              ...
              },
              {
                ...
                info: "Playlist - Our editor’s picks for best Afro songs of the year.",
                src: "https://open.spotify.com/embed/playlist/37i9dQZF1DXdD040nrEzxm?utm_source=generator&theme=0",
              },
              {
                title: "Best of JumpOff 2023",
                info: "Playlist - Editor's pick: The best of JumpOff songs of 2023.",
